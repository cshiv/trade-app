...
#TODO Replace the list with Nifty and Bank nifty. Preferably Futures value to derive SuperTrend and options to trade based on Futures value
...
def run_trategy():
    for i in range(0, len(tickerlist)):
        ...
        try:
            ...
            #TODO Understand the strategy and reason behind up and down
            if super_trend[-1]=='up' and super_trend[-3]=='down' and super_trend[-4]=='down' and super_trend[-5]=='down' and super_trend[-6]=='down':
                ...
                #TODO Mock run with Print statments. Mo need to place order
                #TODO Error handling
                #TODO Map it to Options instead of buying or selling stock
                order = kites[0].place_order(exchange='NSE',
                                             ...
                                             squareoff=target,
                                             #TODO SL based on VWAP???? Find indicator
